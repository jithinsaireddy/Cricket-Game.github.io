...
var player_name = prompt("Enter the Player name");

localStorage.setItem("player", player_name);



var regname = localStorage.getItem('player');

document.getElementById('name').innerHTML = regname;
...
function updatePosition1() {
    ...
    if (position1 > board[99]) {
        ...
        // extrarunAudio();
        msg_out = regname + " gets an extra run!";
        document.querySelector('#msg').innerHTML = msg_out;
        setTimeout(function () {
            document.querySelector('#msg').innerHTML = msg_default;
        }, 1500);
...
function updateScore1() {
    ...
    if (score1 == board[99]) {
        ...
        msg_out = regname + " won the game!";
        document.getElementById('popup').style.visibility = 'visible';
        document.getElementById("result").innerHTML = regname + " Won the game"
        document.querySelector('#msg').innerHTML = msg_out;
        setTimeout(function () {
            document.querySelector('#msg').innerHTML = msg_out;
        }, 1000);

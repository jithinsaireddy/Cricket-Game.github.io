...
var player1_name = prompt("Enter the Player 1 name");
var player2_name = prompt("Enter the Player 2 name");
localStorage.setItem("player1", player1_name);
localStorage.setItem("player2", player2_name);

var regname1 = localStorage.getItem("player1");
var regname2 = localStorage.getItem("player2");

document.getElementById("name1").innerHTML = regname1;
document.getElementById("name2").innerHTML = regname2;
...
function rollDice1() {
  ...
  msg_out = regname1 + " rolled " + pos1;
  document.querySelector("#msg").innerHTML = msg_out;
  setTimeout(function () {
    document.querySelector("#msg").innerHTML = msg_default;
  }, 1500);
  setTimeout(updatePosition1, 1000);
}
// moving icons according to position and declaring wickets
function updatePosition1() {
  ...
  if (position1 > board[99]) {
    ...
    // wicketAudio();
    msg_out = regname1 + " lost a wicket! ";
    document.querySelector("#msg").innerHTML = msg_out;
    setTimeout(function () {
      document.querySelector("#msg").innerHTML = msg_default;
    }, 1500);
    ...
    p1_w++;
    // declaring wickets to win the game
    if (p1_w > 3) {
      document.querySelector("#p1w").innerHTML = p1_w;
      position1 = board[0];
      var element = document.getElementById("img1");
      element.remove();
      let template = '<img src="../images/Cricket.png" id="img1">';
      arrboard[position1 - 1].innerHTML += template;
      msg_out = regname2 + " won the game!";
      document.getElementById("popup").style.visibility = "visible";
      document.getElementById("result").innerHTML = regname2 + " Won The Game";
      document.querySelector("#msg").innerHTML = msg_out;
      setTimeout(function () {
        document.querySelector("#msg").innerHTML = msg_out;
      }, 1000);
  ...
  // }
    ...
    position1 == board[16] ||
    position1 == board[76] || // updationg position for four
    position1 == board[81]
  ) {
    // fourAudio();
    msg_out = regname1 + " hits a Four!";
    document.querySelector("#msg").innerHTML = msg_out;
    setTimeout(function () {
      document.querySelector("#msg").innerHTML = msg_default;
    }, 1500);
    ...
    position1 == board[37] ||
    position1 == board[59] || // position for six
    position1 == board[72]
  ) {
    // sixAudio();
    msg_out = regname1 + " hits a Six!";
    document.querySelector("#msg").innerHTML = msg_out;
    setTimeout(function () {
      document.querySelector("#msg").innerHTML = msg_default;
    }, 1500);
    ...
    // position for extra run
    // extrarunAudio();
    msg_out = regname1 + " gets an extra run!";
    document.querySelector("#msg").innerHTML = msg_out;
    setTimeout(function () {
      document.querySelector("#msg").innerHTML = msg_default;
    }, 1500);
...
function updateScore1() {
  ...
  if (score1 == board[99]) {
    ...
    msg_out = regname1 + " won the game!";
    document.getElementById("popup").style.visibility = "visible";
    document.getElementById("result").innerHTML = regname1 + " Won The Game";
...
function updatePosition2() {
  ...
  if (position2 > board[99]) {
    ...
    // wicketAudio();
    msg_out = regname2 + " lost a wicket!";
    document.querySelector("#msg").innerHTML = msg_out;
    setTimeout(function () {
      document.querySelector("#msg").innerHTML = msg_default;
    }, 1500);
    ...
    if (p2_w > 3) {
      ...
      element.remove();
      let template = '<img src="../images/Cricket_Bat_Ball.png" id="img2">';
  ...
  // }
    ...
    // extrarunAudio();
    msg_out = regname2 + " gets an extra run!";
    document.querySelector("#msg").innerHTML = msg_out;
    setTimeout(function () {
      document.querySelector("#msg").innerHTML = msg_default;
    }, 1500);
